...
function initMagicMove(deck) {
  const containers = document.querySelectorAll('.magic-move');
...
// The native highlight.js tokenizer groups things like "(Year.Release))" as one token,
// but for better magic-move animations we want each parenthesis to be separate.
